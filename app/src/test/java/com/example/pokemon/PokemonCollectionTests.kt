...
class PokemonCollectionTests {
    ...
    @Test
    fun testAddPokemonToCollection() {
        ...
        val pokemon = Pokemon(4, "charmander", "flame", 0, types, 39, 52, 43, 60, 50, 65, moves, images)

        collection.addPokemonToCollection(pokemon)

        Assert.assertEquals(1, collection.getSize())
        Assert.assertEquals(pokemon, collection.getPokemon(0))
    }

    @Test
    fun testSwitchPokemonToCollection() {
        val types = ArrayList<String>()
        types.add("fire")
        ...
        val pokemon = Pokemon(4, "charizard", "flame", 0, types, 39, 52, 43, 60, 50, 65, moves, images)
    ...
    @Test
    fun testRemovePokemonToCollection() {
        val types = ArrayList<String>()
        types.add("fire")
        ...
        collection.removePokemonFromCollection(pokemon)
    ...
    fun testGetPokemon() {
        ...
        collection.addPokemonToCollection(pokemon)
        Assert.assertEquals(1, collection.getSize())
        val pokemonFromCollection = collection.getPokemon(0);
